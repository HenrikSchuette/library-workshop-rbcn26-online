...
class OpenAPIKeywordRunner:
    def __init__(self, open_api_rf_keyword: OpenApiKeyword, base_url: str):
    ...
    def build_result_from_response(self, response):
        if not response.ok:
    ...
    def build_request_body(self, extra_keyword_args):
        request_body = [
