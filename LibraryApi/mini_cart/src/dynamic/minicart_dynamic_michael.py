...
class MiniCartDynamicLibrary:
    ...
    def _build_registry(self) -> dict[str, Callable[..., Any]]:
        ...
        for fn_name in fn_names:
            func = getattr(self._target, fn_name)
            reg[self._to_robot_name(fn_name)] = func
        return reg
